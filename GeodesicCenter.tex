...
Note that if $v_a \neq a$, then both $v_a$ and $v_b$ lie inside the triangle $\triangle(a,b,v)$. 
...
In the next section we use a similar approach to construct a set of apexed triangles (and their corresponding apex functions) to encode the distance from the vertices of $M$.
