...
In this case, the path $\p{u}{v}$ coincides with the path $\p{u}{y}$ all the way from $u$ to $x^*$. Therefore, $\p{u}{v}$ can be partitioned into two paths $\p{u}{x^*}$ and $\p{x^*}{v}$.
Since $y^*$ lies on $\p{u}{x^*}$, we conclude that $\p{u}{v}$
...
In this case the path $\p{u}{v}$ is the union of $\p{u}{u'}, \p{u'}{v'}$ and $\p{v'}{v}$.
