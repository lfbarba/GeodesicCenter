...
\text{Case 1.} If $w_1, w_2, w_3$ makes a left turn, then let $s$ be the first point of the boundary of $\fn{v}{C}$ hit by the ray shooting from $w_3$ in the direction opposite to $w_2$ ($s$ could be equal to $w_3$ if $w_3$ already lies on the boundary).
