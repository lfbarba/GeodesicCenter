...
$$h_i(x, r) \leq 0, \text{ if $x\in \Delta_{i}$ for $1\leq i \leq m$}.$$%\text{ and } r > \max\{\kappa_i\}
...
%\textbf{(P2).} Find a point $(x,r)\in \mathbb{R}^3$ such that $r$ is minimized subject to $x\in q^*$ and 
%$$h_i(x, r) \leq 0 \text{ and } r > \max\{\kappa_i\}\ (1\leq i\leq m), \text{if $x\in \Delta_{i}$ for $1\leq i \leq m$}.$$
